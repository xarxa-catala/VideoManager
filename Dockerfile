...
RUN pip3 install Django mysqlclient django-auth-ldap Pillow pymediainfo ffmpeg-python django-sortedm2m djangorestframework markdown django-q django-cors-headers
